...
int main() {
    ...
    printf("Two threads will try to acquire the same two mutexes in different order.\n\n");
    ...
    // Проверяем, не завершились ли потоки
    printf("\n=== Checking thread status ===\n");
    printf("If threads are deadlocked, they won't complete their work.\n");
    printf("The program will hang here because threads are blocked.\n");
